...
export const projects: IProject[] = [
  {
    ...
    description:
      "DSC UTP Web es la plataforma oficial de Developer Student Clubs UTP. Centraliza información sobre eventos tech, ofertas laborales para estudiantes, comunidades tecnológicas y los proyectos desarrollados internamente. Construida con TanStack Start, React 19, TailwindCSS v4 y desplegada en Cloudflare Workers. El contenido es gestionado vía GitHub Issues con automatización por el agente Jules.",
